	...
	<form action="" method="post" class="searchForm" role="form">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-3">
				<label class="control-label col-lg-5 col-md-5 col-sm-5">楼盘</label>
	...
	<div id="">
		<div class="detail">
			<form method="post" onsubmit="return false" class="">
				<div style="height:24px;">
					...
					<div class="floatRight">
						<input type="button" value="添 加" data-toggle="modal" data-target="#addFloor" /> 
			...
			<table class="dataTable order-column">
				<thead>
					<tr>
						<td>序号</td><td>城市名称</td><td>区域名称</td><td>路</td><td>楼盘</td><td>编辑</td>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>1</td><td>广州市</td><td>白云区</td><td>金沙洲路与环洲二路</td><td>万科爱地社区</td><td><img src="/static/images/rowedit.gif" data-toggle="modal" data-target="#addFloor" /></td>
					</tr>
					<tr>
						<td>1</td><td>广州市</td><td>白云区</td><td>机场路83号</td><td>滨城花园</td><td><img src="/static/images/rowedit.gif" data-toggle="modal" data-target="#addFloor" /></td>
					</tr>
				</tbody>
			</table>
		</div>
	</div>
	<div class="modal fade" id="addFloor" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div style="width: 100%; height: 130px; border: 0px none;">
						<form method="post" onsubmit="return false" class="editForm">
							<div style="height:24px; margin-bottom:10px;">
								...
								<div class="floatRight">
									<input type="button" value="保 存" onclick="saveAddFloor();"/> 
							...
							<table class='cls-data-table-detail'
								...
								<tr>
									<td class='cls-data-th-detail' width="120px">路：
									</td>
									<td class="cls-data-td-editdetail" bgcolor="#ffffff" colspan='7' width="90%">
										<font>
											<select style="width: 95%">
								...
								<tr>
									<td class='cls-data-th-detail' width="120px">楼盘：</td>
